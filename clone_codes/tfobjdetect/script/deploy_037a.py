...
### absolute
MODEL_NAME = '/object-detection/src/tfobjdetect/checkpoints/faster_rcnn_inception_resnet_v2_atrous_oid'
...
### absolute
PATH_TO_LABELS = os.path.join('/object-detection/src/tfobjdetect/lib/object_detection/data', 'oid_bbox_trainable_label_map.pbtxt')
...
with open('../../test/jpg.txt', 'r') as fin:
    test_img_path = ['../../test/jpg/' + line.strip() for line in fin]
...
with open('../../results/det_results_m18_jpg_oi_1.pkl', 'wb') as fout:
...
###
with open('../../model_fusion/temp/imgsize_m18_jpg.pkl', 'wb') as fout:
...
with open('../../results/det_results_m18_jpg_oi_1_filtered.pkl', 'wb') as fout:
