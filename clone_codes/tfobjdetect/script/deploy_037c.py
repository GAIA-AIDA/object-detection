...
with open('../../test/keyframe.txt', 'r') as fin:
    test_img_path = ['../../test/keyframe/' + line.strip() for line in fin]
...
with open('../../results/det_results_m18_kf_oi_1.pkl', 'wb') as fout:
...
with open('../../model_fusion/temp/imgsize_m18_kf.pkl', 'wb') as fout:
...
with open('../../results/det_results_m18_kf_oi_1_filtered.pkl', 'wb') as fout:
